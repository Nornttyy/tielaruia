...
const _DEFS := {
	...
	"sniper":        {"placeable_tile_id": -1, "tool_kind": "gun", "tool_tier": 4, "max_stack": 1, "damage_mult": 1.0, "gun_cooldown": 0.9, "gun_damage": 32, "bullet_speed": 1000, "gun_sfx": "gunshot_heavy", "gun_shake": 2.5},  # 狙击枪: 慢/超狠/弹速超快
	...
	"railgun":       {"placeable_tile_id": -1, "tool_kind": "gun", "tool_tier": 6, "max_stack": 1, "damage_mult": 1.0, "gun_cooldown": 1.0, "gun_damage": 30, "bullet_speed": 1400, "gun_visual": "laser", "gun_pierce": true, "gun_sfx": "gunshot_heavy", "gun_shake": 3.0},  # 电磁炮: 穿透一切, 超快超狠
