...
const _DEFS := {
	...
	"shotgun":       {"placeable_tile_id": -1, "tool_kind": "gun", "tool_tier": 3, "max_stack": 1, "damage_mult": 1.0, "gun_cooldown": 0.65, "gun_damage": 6, "gun_pellets": 5, "gun_spread_deg": 32.0, "bullet_speed": 520, "gun_sfx": "gunshot_heavy"},  # 霰弹枪: 一次5颗扇形/近战狠
	...
	"rocket_gun":    {"placeable_tile_id": -1, "tool_kind": "gun", "tool_tier": 5, "max_stack": 1, "damage_mult": 1.0, "mana_cost": 4, "gun_cooldown": 0.7, "gun_damage": 15, "bullet_speed": 340, "gun_visual": "fire", "gun_homing": 8.0, "bullet_lifetime": 3.0, "gun_sfx": "gunshot_heavy"},  # 追踪火箭: 自动追怪
	...
	"railgun":       {"placeable_tile_id": -1, "tool_kind": "gun", "tool_tier": 6, "max_stack": 1, "damage_mult": 1.0, "gun_cooldown": 1.0, "gun_damage": 30, "bullet_speed": 1400, "gun_visual": "laser", "gun_pierce": true, "gun_sfx": "gunshot_heavy"},  # 电磁炮: 穿透一切, 超快超狠
