...
@export var shirt_style: int = 0       # 0..17 (见 C 完整目录)
@export var pants_style: int = 0       # 0..18 (见 C 完整目录)
...
- **衬衫款 `shirt_style` (16)**: 0 T恤 / 1 背带 / 2 连帽卫衣 / 3 海魂衫(蓝白条纹) / 4 法师袍(上) / 5 骑士胸甲 / 6 泳衣·背心式 / 7 泳衣·吊带式(女=比基尼上衣, 男=吊带) / 8 女仆上装(黑连衣裙上半 + 白围裙白领) / 9 水手服(上, 水手领) / 10 仙女装(上, 梦幻连衣裙上半) / 11 和服(上襟) / 12 忍者服(上, 黑劲装+面巾) / 13 太空服(上, 白宇航服+胸前仪表) / 14 机甲战甲(上, 金属板+能量线) / 15 恐龙连体衣(上, 带恐龙帽) / 16 小狗连体衣(上, 带狗耳帽) / 17 兔子连体衣(上, 带兔耳帽; 可爱萌系, 非夜店兔女郎)。
- **裤子款 `pants_style` (19)**: 0 长裤 / 1 短裤 / 2 裙子 / 3 工装裤 / 4 公主裙(华丽蓬蓬裙) / 5 法师袍(下摆) / 6 骑士护腿 / 7 泳裤 / 8 泳裙(沙滩裤) / 9 女仆裙(黑裙 + 白蕾丝边) / 10 百褶裙(配水手服) / 11 仙女裙(下摆) / 12 和服(下摆) / 13 忍者裤 / 14 太空服(下) / 15 机甲护腿 / 16 恐龙连体衣(下) / 17 小狗连体衣(下) / 18 兔子连体衣(下)。
...
**修改**:
- `scripts/art/player_art.gd` — 重构成分层 `build_sprite_frames(appearance)` (5 层: 披风/身体/裤子/衬衫/头发) + 男/女身体、4 发型、18 衬衫款、19 裤子款、7 披风/背后层款 (含翅膀/恐龙·小狗·兔子尾巴) ascii 模板
...
- **美术量很大** (24×48 画布 + 服装多 + 男女身材不同 + 高细节): 男+女身体各 7 帧 + 4 发型 + (18 衬衫款 + 19 裤子款) **× 男女 fit** + 7 披风/背后层款, 每个 24×48、跨帧对齐、还要明暗纹理。这是本功能的**主要工作量**。控制法: **分批上** (见实现顺序 —— 先框架+男版默认, 再女身体, 再日常款, 再主题套装+披风), 每批能独立跑测试上线; 走路帧腿/靴位置抽成共享坐标常量避免每帧手算; 男女身体共用头/臂/腿锚点行, 让头发+多数衣服只在宽窄上分 male/female-fit, 不全重画; 款式美术加进来不改框架代码 (纯加 ascii 模板 + 1 个 case)。**实现计划里每批款式数量要排到可交付的小块**, 不一口气画完。
...
3. C `player_art.gd` 分层重构 —— **分批**:
   ...
   - C5 主题套装 (法师袍 · 骑士甲 · 公主裙 · 女仆装 · 水手服 · 仙女装 · 和服 · 忍者服 · 太空服 · 机甲战甲 · 恐龙/小狗/兔子连体衣; 每套上+下, 美术量大, 实现计划再细分小批)。
   每批加完跑一次像素断言测试。
